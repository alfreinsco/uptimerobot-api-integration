...
Route::get('/api/dashboard/chart/1hour', [DashboardController::class, 'chartData1Hour'])->name('dashboard.chart.1hour');
Route::get('/api/dashboard/chart/1minute', [DashboardController::class, 'chartData1Minute'])->name('dashboard.chart.1minute');
